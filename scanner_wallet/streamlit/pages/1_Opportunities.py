...
try:
    ...
    DEFAULT_DB_PATH = streamlit_config.database.get_db_path("opportunities")
    ...
    if streamlit_config.features.debug_mode:
        st.success(f"✅ Configuration chargée - DB: {streamlit_config.database.opportunities}")
    
except ImportError:
    DEFAULT_DB_PATH = os.getenv('TRADING_OPPORTUNITIES_DB_PATH', '../database/data/solana_wallet_monitor.db')
