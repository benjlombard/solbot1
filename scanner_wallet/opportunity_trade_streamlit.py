...
st.set_page_config(
    page_title="🔍 Token Scanner Dashboard",
    page_icon="🔍",
    layout="wide",
...
def main():
    ...
    st.title("🔍 Dynamic Token Scanner")
    st.markdown("Scanner de tokens avec filtres dynamiques basé sur l'historique")
    
    # Configuration de la base de données
    db_path = st.text_input(
        "📁 Chemin de la base de données",
        value="solana_wallet_monitor.db",
        help="Chemin vers votre fichier SQLite"
    )
