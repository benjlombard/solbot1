...
class SolanaWalletMonitor:
    ...
    def get_balance_changes_for_wallet(self, wallet_address: str, limit: int = 20) -> List[Dict]:
        """
    ...
    def analyze_balance_change_transaction(self, tx_detail: Dict, wallet_address: str, 
