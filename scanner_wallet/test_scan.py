...
def test_single_scan():
    ...
    try:
        ...
        from rpc.client import SolanaRPCClient
    ...
    try:
        ...
        with db.get_connection() as conn:
            ...
            cursor.execute("""
                ...
                (wallet_address, started_at, completed_at, scan_duration, new_accounts, total_accounts) 
                VALUES (?, ?, ?, ?, ?, ?)
            """, ("TEST_WALLET_ADDRESS", test_time, test_time, 1.0, 0, 0))
