...
logger = logging.getLogger('solana_monitoring')  # Utiliser le même logger que jup_db_scan_k2_g3_c1.py
...
async def validate_token_on_chain(token_address: str, client: AsyncClient) -> dict:
    ...
    try:
        ...
        if account_info.value:
            ...
            logger.debug(f"✅ Token {token_address} validated on-chain: mint={is_token_mint}, owner={owner}, data={data_length}b")
