...
class Settings:
    def __init__(self):
        ...
        self.enrichment_batch_size: int = int(os.getenv("ENRICHMENT_BATCH_SIZE", "50"))
        self.enrichment_update_interval_minutes: int = int(os.getenv("ENRICHMENT_UPDATE_INTERVAL_MINUTES", "5"))
