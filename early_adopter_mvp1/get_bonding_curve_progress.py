...
if __name__ == "__main__":
    async def main():
        ...
        result1 = await get_pump_progress_correct("HhVvQrEqV4gBVSX7EQmgFT94tve1kz5RGs5PJzhaijWX")
        
        # Test avec la méthode alternative
        result2 = await get_pump_progress_token_account("HhVvQrEqV4gBVSX7EQmgFT94tve1kz5RGs5PJzhaijWX")
